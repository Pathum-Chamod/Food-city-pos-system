...
class _CustomerPickerDialogState extends State<_CustomerPickerDialog> {
  ...
  Widget _buildCustomerCard(Customer customer) {
    ...
    final isSelected = widget.selectedCustomer?.id != null &&
        ...
        child: Ink(
          ...
          child: Row(
            children: [
              CircleAvatar(
                radius: 22,
                backgroundColor: typeColor.withOpacity(isDark ? 0.18 : 0.12),
                child: Text(
              ...
              Flexible(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: typeColor.withOpacity(isDark ? 0.16 : 0.10),
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.groups_rounded, color: _brand, size: 28),
                  ),
                        ...
                        TextButton.icon(
                          onPressed: () {
                            Navigator.of(context).pop(
                              const CustomerPickerResult(customer: null, cleared: true),
                            );
                          },
                        ...
                        ? Center(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Icon(Icons.person_search_rounded, size: 42, color: textSecondary),
                                  const SizedBox(height: 12),
                                  Text(
                                    'No customers found',
                                    style: TextStyle(
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: _isLoading
                          ? null
                          : () {
                              _showMessage('Customer list refreshed.', color: _success);
                              _loadCustomers();
                            },
