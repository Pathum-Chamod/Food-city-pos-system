...
class _CustomerDetailScreenState extends State<CustomerDetailScreen> {
  ...
  Future<void> _loadCustomer() async {
    ...
    try {
      ...
      final history = await service.getCustomerPurchaseHistory(widget.customerId);
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    if (customer.hasEmail) _infoLine(Icons.email_rounded, customer.email!),
                    if (customer.hasAddress) _infoLine(Icons.location_on_rounded, customer.address!),
                  ],
                ),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 42,
            decoration: BoxDecoration(
              color: (isRefund ? _danger : _brand).withOpacity(_isDark ? 0.16 : 0.10),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            _metricCard(
                              label: 'Total Spent',
                              value: _money(((_summary['net_total_spent'] as num?) ?? 0).toDouble()),
                            ...
                            _metricCard(
                              label: 'Sales',
                              value: (((_summary['sale_count'] as num?) ?? 0).toInt()).toString(),
                            ...
                            _metricCard(
                              label: 'Average Sale',
                              value: _money(((_summary['average_sale'] as num?) ?? 0).toDouble()),
                            ...
                            _metricCard(
                              label: 'Refunds',
                              value: (((_summary['refund_count'] as num?) ?? 0).toInt()).toString(),
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: _infoBlock(
                                  'Total transactions',
                                  (((_summary['transaction_count'] as num?) ?? 0).toInt()).toString(),
                                ),
                              ),
                            ],
                          ),
